      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {CYBERPUNK_BODY_ZONES.map((zone) => {
          ...
          return (
            ...
            >
              <div>
                <div className="flex items-start justify-between pb-2 border-b border-[#6C00FF]/20 mb-2.5 gap-2">
                  <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 min-w-0 flex-1">
                    ...
                    {((zone as any).english || zone.suggestedTraits) && (
                      <span className="text-[10px] text-[#F5F500] font-mono leading-tight break-words">
                        {(zone as any).english || zone.suggestedTraits}
                      </span>
                    )}
                  </div>
                  <div className="text-xs font-mono shrink-0 whitespace-nowrap pt-0.5">
