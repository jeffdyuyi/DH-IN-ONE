...
export const THEMES: Record<ThemeType, any> = {
  default: { 
    ...
    text: 'text-[#f5f0ff]', 
    accent: 'text-[#e5b83b]', 
    border: 'border-[#e5b83b]/60', 
    metaBg: 'bg-[#20173d]', 
    card: { 
      isDark: true,
      bg: 'bg-[#1e163b]', 
      border: 'border-[#e5b83b]/40', 
      text: 'text-[#f5f0ff]', 
      textMuted: 'text-[#a39bc0]',
      enemyBar: 'bg-[#e11d48]', 
      envBar: 'bg-[#48c6b6]',
      nameText: 'text-[#ffffff]',
      nameEnText: 'text-[#e5b83b]',
      badgeTier: 'bg-[#2a1f4f] text-[#f5d166] border border-[#e5b83b]/30',
      badgeTypeEnemy: 'bg-[#4c0519] text-[#fda4af] border border-[#e11d48]/40',
      badgeTypeEnv: 'bg-[#042f2e] text-[#5eead4] border border-[#48c6b6]/40',
      badgeNpc: 'bg-[#3b1260] text-[#e9d5ff] border border-[#a855f7]/40',
      avatarBorder: 'border-[#e5b83b]',
      metaBox: 'bg-[#251b47] border border-[#3b2d6a]',
      metaLabelEnemy: 'text-[#fda4af]',
      metaLabelEnv: 'text-[#5eead4]',
      metaText: 'text-[#ede8fb]',
      statBox: 'bg-[#130d24] border border-[#34275c]',
      statItem: 'bg-[#211742] border border-[#3c2d6a]',
      statLabel: 'text-[#a39bc0]',
      statVal: 'text-[#f5f0ff]',
      statHpVal: 'text-[#fb7185]',
      statStressVal: 'text-[#f5d166]',
      hpDot: 'border-rose-400 bg-rose-500/30',
      stressDot: 'border-amber-400 bg-amber-500/30',
      attackName: 'text-[#fb7185]',
      attackTypeMagic: 'bg-[#3b1260] text-[#e9d5ff]',
      attackTypePhys: 'bg-[#2b214c] text-[#ede8fb]',
      attackStats: 'text-[#f5d166]',
      traitName: 'text-[#ffffff]',
      traitDescBorder: 'border-[#3b2d6a]',
      traitFlavor: 'text-[#a39bc0]',
      traitPassive: 'bg-[#2a1f4f] text-[#ede8fb]',
      traitAction: 'bg-[#451a03] text-[#fde047]',
      traitSpotlight: 'bg-[#4c0519] text-[#fecdd3]',
      traitReaction: 'bg-[#1e1b4b] text-[#c7d2fe]',
      specialBox: 'bg-[#2a2015] border-2 border-dashed border-[#e5b83b]',
      specialTitle: 'text-[#f5d166]',
      specialTag: 'bg-[#451a03] text-[#fde047]',
      specialText: 'text-[#f5f0ff]',
      countdownBox: 'bg-[#0f2926] border border-[#48c6b6]',
      countdownTitle: 'text-[#5eead4]',
      countdownBadge: 'bg-[#48c6b6] text-[#0f2926]',
      countdownText: 'text-[#ccfbf1]',
      gmQuestionBox: 'bg-[#251b47] border border-[#e5b83b]/30',
      gmQuestionTitle: 'text-[#f5d166]',
      gmQuestionText: 'text-[#ede8fb]'
    } 
  },
  parchment: { 
    name: '羊皮复古 (亮色)', 
